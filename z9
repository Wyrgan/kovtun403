INSERT INTO cities (nameRus, nameEng) 
VALUES ('Могилёв', 'Mogilev'), ('Железногорск', 'Jeleznogorsk'), ('Барнаул', 'Barnaul');
...
UPDATE users SET age = (YEAR(CURRENT_DATE) - YEAR(dateOfBirth));
